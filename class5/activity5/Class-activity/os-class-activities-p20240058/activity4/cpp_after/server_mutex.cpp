...
const int PORT = 9002; // Using a different port for the fixed version
const std::string FILE_NAME = "shared_score.txt";
std::mutex file_mutex; // The lock that will protect our file

int update_score(const std::string& name) {
    // RAII Lock: Automatically locks here, forces other threads to wait in line
